...
We begin with a brief mention of active contour models with level set formulation \cite{Osher:1988:LVset}. At first, a parametric active contour model proposed in \cite{Kass:1988:Snakes} formulated by minimizing an energy functional. In \cite{Xu:2000:ParamGeoAC} active contours are  In A, the active contour was formulated in the level set framework, and it showed better performance than minimizing the energy function in a more intuitive way by designing the force itself acting on the contour.
