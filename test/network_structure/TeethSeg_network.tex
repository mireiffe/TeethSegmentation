...
\begin{figure}
	...
	\begin{scope}[on background layer]
		\draw[black,line width=.4mm,dashed] ($(title_a.west)+(-2.5,0)$)  rectangle ($(title_a.east)+(2,-28.5*\segvgap)$);
		\draw[black,line width=.4mm,dashed] ($(title_b.west)+(-.8,0)$)  rectangle ($(title_b.east)+(.8,-28.5*\segvgap)$);
	\end{scope}
  \end{tikzpicture}
