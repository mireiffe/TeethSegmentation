\begin{figure}[]
    ...
    \begin{subfigure}[]{\twdth \textwidth}
        ...
        \label{Fig:ours}
    \end{subfigure}
    \caption{ Segmentation results of teeth images using various methods~\cite{T000,T008,T005,T018,T013,T001_21}. MWA in (b) is the modified watershed algorithm~\cite{Na:2014LteethMorph}. MRCNN and MRCNN2 are methods based on Mask R-CNN in~\cite{He:2018:MRCNN,Zhu:2020:teethMaskrcnn} and~\cite{Kim:2020}, respectively. In (e), the results using our algorithm are presented. }
    \label{Fig:results}
\end{figure}