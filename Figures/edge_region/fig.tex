\begin{figure}
    ...
    \caption{ (a) A synthetic image, a teeth image without light reflection, and a teeth image with light reflection are shown from top to bottom~(Reprinted from~\cite{T001_21}). (b) Edge-region candidates $\ome$ of the left images. (c) Edge-region $\oma$ is refined using component size and image intensity. }
